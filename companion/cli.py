...
async def _run_interactive_editor(
    ...
    # Get placeholder text from previous session's generated prompts
    placeholder = ""
    if recent_entries and recent_entries[0].next_session_prompts:
        # Use the prompt generated after the last entry was analyzed
        placeholder = recent_entries[0].next_session_prompts[0]
    else:
        # First-time user or no previous prompts
